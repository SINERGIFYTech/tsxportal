...
$(document).ready(function () {
  ...
  setCookie("adminuiuxtheme", "theme-cyan", 1);
  /* color style  */
  var curentstyle = body.attr("data-theme");
  if (
    $.type(getCookie("adminuiuxtheme")) != "undefined" &&
    getCookie("adminuiuxtheme") != ""
  ) {
  ...
  /* background images */
  if (
    $.type(getCookie("adminuiuxsetimagepath")) != "undefined" &&
    getCookie("adminuiuxsetimagepath") != ""
  ) {
    $(".main-bg").each(function () {
      $(this).css(
        "--adminuiux-main-bg",
        'url("../../' + getCookie("adminuiuxsetimagepath") + '")'
      );
    });
  ...
  if (
    $.type(getCookie("adminuiuxsidebarfilled")) != "undefined" &&
    getCookie("adminuiuxsidebarfilled") != ""
  ) {
    body
      .removeClass(curentSidebarFill)
      .addClass(getCookie("adminuiuxsidebarfilled"))
      .attr("data-sidebarfill", getCookie("adminuiuxsidebarfilled"));
  ...
  $("#personalise-preview-sidebar .select-box").on("click", function () {
    ...
    if (setSidebarfill != "") {
      body
        .removeClass(getCookie("adminuiuxsidebarfilled"))
  ...
  if (
    $.type(getCookie("adminuiuxsidebarlayout")) != "undefined" &&
    getCookie("adminuiuxsidebarlayout") != ""
  ) {
    body
      .removeClass(currentsidebarlayout)
      .addClass(getCookie("adminuiuxsidebarlayout"))
      .attr("data-sidebarlayout", getCookie("adminuiuxsidebarlayout"));
  ...
  $(".sidebar-layout .select-box").on("click", function () {
    ...
    body
      .removeClass(currentsidebarlayout)
      .attr("data-sidebarlayout", setSidebarlayout);
    ...
    if (setSidebarlayout != "") {
      body
        .removeClass(getCookie("adminuiuxsidebarlayout"))
        .addClass(setSidebarlayout);
  ...
  /* header style */
  if (
    $.type(getCookie("adminuiuxheaderfilled")) != "undefined" &&
    getCookie("adminuiuxheaderfilled") != ""
  ) {
  ...
  $("#personalise-preview-header .select-box").on("click", function () {
    ...
    if (setheaderfill != "") {
      body
        .removeClass(getCookie("adminuiuxheaderfilled"))
        .addClass(setheaderfill);
  ...
  if (
    $.type(getCookie("adminuiuxheaderlayout")) != "undefined" &&
    getCookie("adminuiuxheaderlayout") != ""
  ) {
    body
      .removeClass(currentheaderlayout)
      .addClass(getCookie("adminuiuxheaderlayout"))
      .attr("data-headerlayout", getCookie("adminuiuxheaderlayout"));
  ...
  $("#header-layout .select-box").on("click", function () {
    ...
    body
      .removeClass(currentheaderlayout)
      .attr("data-headerlayout", setheaderlayout);
    ...
    if (setheaderlayout != "") {
      body
        .removeClass(getCookie("adminuiuxheaderlayout"))
        .addClass(setheaderlayout);
  ...
  if (
    $.type(getCookie("adminuiuxbggradient")) != "undefined" &&
    getCookie("adminuiuxbggradient") != ""
  ) {
    body
      .removeClass(currentbggradient)
      .addClass(getCookie("adminuiuxbggradient"))
      .attr("data-bggradient", getCookie("adminuiuxbggradient"));
  ...
  $(".theme-background .gradient-box").on("click", function () {
    ...
    if (setbggradient != "") {
      body
        .removeClass(getCookie("adminuiuxbggradient"))
        .addClass(setbggradient);
